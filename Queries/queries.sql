...
-- Joining retirement_info and dept_emp table and use ri and de as nickmames 
SELECT 
ri.emp_no,
ri.first_name,
ri.last_name,
...
-- List: 1 = Join three tables: the employees table with salaries table dept_emp table
SELECT 
e.emp_no, 
e.first_name, 
e.last_name,
...
-- List: 2 = Join three tables: Departments, Managers and Employees
SELECT  dm.dept_no,
        d.dept_name,
        dm.emp_no,
        ce.last_name,
